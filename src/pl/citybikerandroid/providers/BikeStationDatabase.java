...
public class BikeStationDatabase {
	 ...
	 //The columns we'll include in the dictionary table
	    ...
	    private static HashMap<String,String> buildColumnMap() {
	        ...
	        map.put(KEY_STATION_NAME, KEY_STATION_NAME);
	        map.put(KEY_STATION_ID, KEY_STATION_ID);
...
//	        return query(selection, selectionArgs, columns);
	    ...
	    private static class BikeStationOpenHelper extends SQLiteOpenHelper {
	        ...
	        BikeStationOpenHelper(Context context) {
...
//	            }
	         ...
	         */
	        public long addWord(String stationName, String stationId) {
	            ContentValues initialValues = new ContentValues();
		            initialValues.put(KEY_STATION_NAME, stationName);
